...
class TestTasks:
    ...
    def test_raw_response_create(self, client: Julep) -> None:
        response = client.agents.tasks.with_raw_response.create(
            agent_id="agent_id",
            main=[{"evaluate": {"foo": "string"}}],
            name="name",
        )
    ...
    def test_streaming_response_create(self, client: Julep) -> None:
        with client.agents.tasks.with_streaming_response.create(
            agent_id="agent_id",
            main=[{"evaluate": {"foo": "string"}}],
            name="name",
        ) as response:
    ...
    def test_path_params_create(self, client: Julep) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `agent_id` but received ''"):
            client.agents.tasks.with_raw_response.create(
                agent_id="",
                main=[{"evaluate": {"foo": "string"}}],
                name="name",
            )
    ...
    def test_raw_response_list(self, client: Julep) -> None:
        response = client.agents.tasks.with_raw_response.list(
            agent_id="agent_id",
        )
    ...
    def test_streaming_response_list(self, client: Julep) -> None:
        with client.agents.tasks.with_streaming_response.list(
            agent_id="agent_id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_path_params_list(self, client: Julep) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `agent_id` but received ''"):
            client.agents.tasks.with_raw_response.list(
                agent_id="",
            )

    @parametrize
    def test_method_create_or_update(self, client: Julep) -> None:
        task = client.agents.tasks.create_or_update(
            task_id="task_id",
            agent_id="agent_id",
            main=[{"evaluate": {"foo": "string"}}],
            name="name",
    ...
    def test_raw_response_create_or_update(self, client: Julep) -> None:
        response = client.agents.tasks.with_raw_response.create_or_update(
            task_id="task_id",
            agent_id="agent_id",
            main=[{"evaluate": {"foo": "string"}}],
            name="name",
    ...
    def test_streaming_response_create_or_update(self, client: Julep) -> None:
        with client.agents.tasks.with_streaming_response.create_or_update(
            task_id="task_id",
            agent_id="agent_id",
            main=[{"evaluate": {"foo": "string"}}],
            name="name",
    ...
    def test_path_params_create_or_update(self, client: Julep) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `agent_id` but received ''"):
            client.agents.tasks.with_raw_response.create_or_update(
                task_id="task_id",
                agent_id="",
                main=[{"evaluate": {"foo": "string"}}],
                name="name",
...
class TestAsyncTasks:
    ...
    async def test_method_create(self, async_client: AsyncJulep) -> None:
        task = await async_client.agents.tasks.create(
            agent_id="agent_id",
            main=[{"evaluate": {"foo": "string"}}],
            name="name",
        )
    ...
    async def test_raw_response_create(self, async_client: AsyncJulep) -> None:
        response = await async_client.agents.tasks.with_raw_response.create(
            agent_id="agent_id",
            main=[{"evaluate": {"foo": "string"}}],
            name="name",
        )
    ...
    async def test_streaming_response_create(self, async_client: AsyncJulep) -> None:
        async with async_client.agents.tasks.with_streaming_response.create(
            agent_id="agent_id",
            main=[{"evaluate": {"foo": "string"}}],
            name="name",
        ) as response:
    ...
    async def test_path_params_create(self, async_client: AsyncJulep) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `agent_id` but received ''"):
            await async_client.agents.tasks.with_raw_response.create(
                agent_id="",
                main=[{"evaluate": {"foo": "string"}}],
                name="name",
            )
    ...
    async def test_method_list(self, async_client: AsyncJulep) -> None:
        task = await async_client.agents.tasks.list(
            agent_id="agent_id",
        )
    ...
    async def test_raw_response_list(self, async_client: AsyncJulep) -> None:
        response = await async_client.agents.tasks.with_raw_response.list(
            agent_id="agent_id",
        )
    ...
    async def test_streaming_response_list(self, async_client: AsyncJulep) -> None:
        async with async_client.agents.tasks.with_streaming_response.list(
            agent_id="agent_id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_list(self, async_client: AsyncJulep) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `agent_id` but received ''"):
            await async_client.agents.tasks.with_raw_response.list(
                agent_id="",
            )

    @parametrize
    async def test_method_create_or_update(self, async_client: AsyncJulep) -> None:
        task = await async_client.agents.tasks.create_or_update(
            task_id="task_id",
            agent_id="agent_id",
            main=[{"evaluate": {"foo": "string"}}],
            name="name",
    ...
    async def test_raw_response_create_or_update(self, async_client: AsyncJulep) -> None:
        response = await async_client.agents.tasks.with_raw_response.create_or_update(
            task_id="task_id",
            agent_id="agent_id",
            main=[{"evaluate": {"foo": "string"}}],
            name="name",
    ...
    async def test_streaming_response_create_or_update(self, async_client: AsyncJulep) -> None:
        async with async_client.agents.tasks.with_streaming_response.create_or_update(
            task_id="task_id",
            agent_id="agent_id",
            main=[{"evaluate": {"foo": "string"}}],
            name="name",
    ...
    async def test_path_params_create_or_update(self, async_client: AsyncJulep) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `agent_id` but received ''"):
            await async_client.agents.tasks.with_raw_response.create_or_update(
                task_id="task_id",
                agent_id="",
                main=[{"evaluate": {"foo": "string"}}],
                name="name",
